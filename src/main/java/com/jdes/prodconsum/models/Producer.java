...
public class Producer {
	...
	public synchronized void cookBurger (Burger burger) {
	...
	public synchronized void placeBurgerInBuffer(Burger burger, BlockingQueue<Burger> buffer) {
